    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><img src="<?php echo htmlspecialchars($product['image']); ?>" alt="Product Image" class="product-image"></td>
          <td><small><?php echo htmlspecialchars($product['description']); ?></small></td>
          <td><small>£<?php echo htmlspecialchars(number_format($product['price'], 2)); ?></small></td>
          <td>
